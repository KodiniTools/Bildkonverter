...
function createPdfCommentPage(pdf, options = {}) {
  ...
  if (options.commentText && options.commentText.trim()) {
    ...
    // ==============================================================================
    // KORREKTUR: Text normalisieren, um Copy&Paste-Fehler zu beheben
    ...
    const textLines = pdf.splitTextToSize(normalizedText, textWidth); // Normalisierten Text verwenden
